...
<head>
	...
	<!-- Bootstrap -->
	<link type="text/css" rel="stylesheet" href="<?php echo $this->static_base_url; ?>css/bootstrap.min.css" />

	<!-- Custom stlylesheet -->
	<link type="text/css" rel="stylesheet" href="<?php echo $this->static_base_url; ?>css/style2.css" />
...
<body>
                ...
                <div class="row">
                    <div class="booking-form">
						...
						<!-- <form> -->
							...
							<div class="form-btn">
								<button class="bookingbutton" id="bookingbutton">Book Now</button>
							</div>
						</form>
					</div>
				</div>
	...
	<script src="<?php echo $this-> static_base_url; ?>js/jquery.min.js"></script>
	<script>
