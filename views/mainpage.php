            ...
            <div class="carousel-item active">
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="img-box">
                      <img src="<?php echo $this-> static_base_url;?>images/slider-img.png" alt="">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="detail-box">
                      ...
                      <p class="col-lg-11 px-0">
                      sasti aur salamat 'book it' apni baki uber ola walo ki kashti dubey hamari 'book it ' space mai rocket hamari.                 </p>
                      <a href="">
                        Read More
                      </a>
                    </div>
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                <div class="input-group ">
                  ...
                  <input type="text" name="car_type" class="form-control" id="car_type" placeholder="Car Type">
                </div>
              </div>
              <div class="form-group col-md-6">
                <div class="input-group ">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                <div class="input-group ">
                  ...
                  <input type="text" name="pickup_location" class="form-control" id="pickup_loaction" placeholder="Pickup Location ">
                </div>
              </div>
              <div class="form-group col-md-6">
                <div class="input-group ">
  ...
  <section class="about_section layout_padding">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="<?php echo $this-> static_base_url;?>images/about-img.png" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
      ...
      <div class="why_container">
        <div class="row">
          <div class="col-md-4">
            <div class="box b1">
              <div class="img-box">
                <img src="<?php echo $this-> static_base_url;?>images/w1.png" alt="" class="" />
              </div>
              <div class="detail-box">
                <h5>
                  Fast & Easy Booking
          ...
          <div class="col-md-4">
            <div class="box b2">
              <div class="img-box">
                <img src="<?php echo $this-> static_base_url;?>images/w2.png" alt="" class="" />
              </div>
              <div class="detail-box">
                <h5>
                  Driving safety
          ...
          <div class="col-md-4">
            <div class="box b3">
              <div class="img-box">
                <img src="<?php echo $this-> static_base_url;?>images/w3.png" alt="" class="" />
              </div>
              <div class="detail-box">
                <h5>
                  Full Satisfaction
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <div class="btn-box">
              <a href="">
                <img src="<?php echo $this-> static_base_url;?>images/app_store.png" alt="">
              </a>
              <a href="">
                <img src="<?php echo $this-> static_base_url;?>images/google_play.png" alt="">
              </a>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="img-box">
            <img src="<?php echo $this-> static_base_url;?>images/app-img.png" alt="">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box">
            <div class="img-box">
              <img src="<?php echo $this-> static_base_url;?>images/b1.jpg" alt="">
            </div>
            <div class="detail-box">
              <h6 class="blog_date">
                29 July 2020
        ...
        <div class="col-md-6">
          <div class="box">
            <div class="img-box">
              <img src="<?php echo $this-> static_base_url;?>images/b2.jpg" alt="">
            </div>
            <div class="detail-box">
              <h6 class="blog_date">
                30 July 2020
        ...
        <div id="carouselExample2Controls" class="carousel slide" data-ride="carousel">
          <ol class="carousel-indicators">
            <li data-target="#carouselExample2Controls" data-slide-to="0" class="active">
              <img src="<?php echo $this-> static_base_url;?>images/c1.jpg" alt="">
            </li>
            <li data-target="#carouselExample2Controls" data-slide-to="1">
              <img src="<?php echo $this-> static_base_url;?>images/c2.jpg" alt="">
            </li>
            <li data-target="#carouselExample2Controls" data-slide-to="2">
              <img src="<?php echo $this-> static_base_url;?>images/c3.jpg" alt="">
            </li>
          </ol>
          <div class="carousel-inner">
            <div class="carousel-item active">
